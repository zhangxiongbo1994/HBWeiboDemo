...
//        CFRelease(sfontRef);
 ...
 //   }
    UIFont*font=[UIFont systemFontOfSize:13];
    CTFontRef fontRef=CTFontCreateWithName((__bridge CFStringRef)(font.fontName),font.pointSize,NULL);
    NSMutableAttributedString * strings=[[NSMutableAttributedString alloc]initWithString:@"star:" attributes:[NSDictionary dictionaryWithObjectsAndKeys:(__bridge id)fontRef,kCTFontAttributeName,[UIColor blueColor].CGColor,kCTForegroundColorAttributeName,nil]];
    self.title=strings;
